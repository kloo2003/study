<template>
  ...
  <div class="policy">
      ...
      <span class="text">依据《网络安全法》，为保障您的账户安全和正常使用，请尽快完成手机号验证！ 新版<a href="#"
              class="policy">《京东隐私政策》</a>已上线，将更有利于保护您的个人隐私。</span>
  </div>
  <!-- 主界面 -->
  <div class="main">
      <!-- 主界面下的子盒子用于放背景图片 -->
      <div class="img">
          <img src="./image/Login1.png" width="475" height="475">
          <!-- 登录页 -->
          <div class="login">
              <!-- 登录页顶部 -->
              <div class="top">
                  ...
                  <div class="m">
                      <div class="show">
                          <div class="inputs">
                              ...
                              <a href="#">忘记密码</a>
                              <input type="button" class="button" value="登&nbsp;&nbsp;&nbsp;&nbsp;录" @click="out()">
                          </div>
                      </div>
                  </div>
              </div>
...
/* 取消放上去的下划线 */
.main .img .login a:hover {
  text-decoration: none;
}

.main .img .login .right a {
  color: #E93854;
  font-weight: bolder;
}
...
/* 调整底部的一些细节 图标与文字的位置等 */
.login-bottom .other-login a {
  position: relative;
  font-size: 12px;
  bottom: 5px;
}

.login-bottom .enroll a {
  position: relative;
  font-family: SimSun;
  font-size: 14px;
  color: #E93854;
...
/* 底部基础设置 与中央部分的距离调整 文字居中 字体、字号、颜色 */
.bottom {
  margin-top: 25px;
  text-align: center;
  font-size: 12px;
